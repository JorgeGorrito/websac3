...
type complianceRiskAnalystRole struct{}

func ComplianceRiskAnalystRole() Seeder { return &complianceRiskAnalystRole{} }

func (s *complianceRiskAnalystRole) Seed(ctx _db.Context) error {
	dbCtx, ok := ctx.(*db.Context)
	if !ok {
		return errors.New("invalid db context type")
	}

	// 1) Create/find ProfessionalRole: Compliance & Risk Analyst
	var role model.ProfessionalRole
	if err := dbCtx.DB().Where("name = ?", "Compliance & Risk Analyst").First(&role).Error; err != nil {
		// Try to create if not exists
		role = model.ProfessionalRole{Name: "Compliance & Risk Analyst"}
	...
	// 2) Define KA expected for Compliance & Risk Analyst (weights sum to 1.0)
	...
	cfg := []kaCfg{
		{
			...
			Topics: []topicCfg{
				{Name: "Risk Management - Risk Identification", Hours: 10},
				{Name: "Risk Management - Risk Assessment and Analysis", Hours: 12},
				{Name: "Risk Management - Insider Threats", Hours: 8},
				{Name: "Risk Management - Risk Measurement and Evaluation Models and Methodologies", Hours: 10},
				{Name: "Risk Management - Risk Control", Hours: 8},
				{Name: "Security Governance and Policy - Organizational Context", Hours: 8},
				{Name: "Security Governance and Policy - Privacy", Hours: 8},
				{Name: "Security Governance and Policy - Law, Ethics, and Compliance", Hours: 10},
				...
				{Name: "Security Program Management - Assurance and Quality Control", Hours: 8},
		...
		},
		{
			...
			Topics: []topicCfg{
				{Name: "Information Storage Security - Data Security Legislation", Hours: 10},
				...
				{Name: "Usable Security and Privacy - Policy Awareness and Understanding", Hours: 4},
				{Name: "Usable Security and Privacy - Design Guidance and Implications", Hours: 4},
		...
		{
			Name: "Human Security", Weight: 0.20,
			Topics: []topicCfg{
				{Name: "Personal Compliance with Cybersecurity Rules/Policies/Ethical Norms - System Misuse and User Misbehavior", Hours: 8},
				{Name: "Personal Compliance with Cybersecurity Rules/Policies/Ethical Norms - Enforcement and Rules of Behavior", Hours: 6},
				{Name: "Personal Compliance with Cybersecurity Rules/Policies/Ethical Norms - Appropriate Behavior under Uncertainty", Hours: 6},
				{Name: "Awareness and Understanding - Risk Perception and Communication", Hours: 8},
				{Name: "Awareness and Understanding - Cyber Hygiene", Hours: 6},
				{Name: "Awareness and Understanding - Cybersecurity User Education", Hours: 6},
				{Name: "Awareness and Understanding - Awareness of Cyber Vulnerabilities and Threats", Hours: 6},
				{Name: "Social and Personal Privacy - Privacy and Security in Social Networks", Hours: 4},
				{Name: "Usable Security and Privacy - Usability and User Experience", Hours: 4},
				{Name: "Usable Security and Privacy - Human Security Factors", Hours: 4},
		...
		},
		{
			...
			Topics: []topicCfg{
				...
				{Name: "System Control - Attacks", Hours: 4},
	...
	// 4) Assign Compliance & Risk Analyst role to all existing degree programs
