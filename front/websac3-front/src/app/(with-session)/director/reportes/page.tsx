          ...
          <div className="flex-1 overflow-y-auto">
            {reportDetailLoading ? (
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                {/* Title */}
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">Reporte de Evaluación</h2>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">SNIES Institución</div>
                          <div className="text-sm font-bold text-gray-800">
                            {reportDetail.degree_program?.higher_education_institution?.snies || 'N/A'}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">Institución</div>
                          <div className="text-sm font-bold text-gray-800">
                            {reportDetail.degree_program?.higher_education_institution?.name || 'No disponible'}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">Fecha del reporte</div>
                          <div className="text-sm font-bold text-gray-800">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">SNIES Programa</div>
                          <div className="text-sm font-bold text-gray-800">{reportDetail.degree_program?.snies || 'N/A'}</div>
                        </div>
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">Programa</div>
                          <div className="text-sm font-bold text-gray-800">{reportDetail.degree_program?.name || 'No disponible'}</div>
                        </div>
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">Rol profesional</div>
                          <div className="text-sm font-bold text-gray-800">{reportDetail.professional_role?.name || 'No disponible'}</div>
                        </div>
                        <div>
                          <div className="text-xs text-gray-500 font-medium mb-1">Puntaje total</div>
                          <div className="text-sm font-bold text-gray-800">{formatScore(reportDetail.score || 0)}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {reportDetail.unexpected_knowledge_area_reports && reportDetail.unexpected_knowledge_area_reports.length > 0 && (
                  <>
                    <hr className="border-green-500 my-6" />
                    ...
                    {reportDetail.unexpected_knowledge_area_reports.map((area, index) => (
                      <div key={index} className="mb-4 border border-green-200 rounded-lg bg-green-50 p-4">
                          ...
                          <table className="w-full border-collapse border border-green-300">
                            <thead>
                              <tr className="bg-green-100">
                                <th className="border border-green-300 px-3 py-2 text-left text-xs font-medium text-green-800">
                                  Temática
                                </th>
                                <th className="border border-green-300 px-3 py-2 text-left text-xs font-medium text-green-800">
                                  Horas cubiertas
                            ...
                            <tbody>
                              {area.topic_reports?.map((topic, topicIndex) => (
                                <tr key={topicIndex}>
                                  <td className="border border-green-300 px-3 py-2 text-xs text-gray-800">
                                    {topic.name}
                                  </td>
                                  <td className="border border-green-300 px-3 py-2 text-xs text-gray-800">
                                    {topic.learn_hours_actual.toFixed(2)}
